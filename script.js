...
const translations = {
  es: {
    tagline: "Jevel es un sello musical independiente,<br>con un enfoque en música ídish y klezmer.",
    ...
    gameDesc1: "Inspirado en la <em>folk lid</em> de Mark Markovich Warshawsky, <strong>Oyfn Pripetshik: El Juego</strong> es una manera entretenida de aprender el alef-beys.",
  ...
  en: {
    ...
    gameLabel: "the game",
    gameSubtitle: "komets-aleph — oy vey!",
    gameDesc1: "Inspired by the <em>folk lid</em> by Mark Markovich Warshawsky, <strong>Oyfn Pripetshik: The Game</strong> is a fun way to learn the alef-beys.",
  ...
  pt: {
    ...
    gameDesc1: "Inspirado na <em>folk lid</em> de Mark Markovich Warshawsky, <strong>Oyfn Pripetshik: O Jogo</strong> é uma forma divertida de aprender o alef-beys.",
